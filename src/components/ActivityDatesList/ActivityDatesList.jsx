                    ...
                    columns={[
                        {
                            ...
                            title: '',
                            flex: 1,
                            render: (_, record) => <Typography.Text>{types[record.type]}</Typography.Text>
                        },
                        {
                            dataIndex: 'date',
                            key: 'date',
                            title: '',
                            render: (_, record) => <Typography.Text>{dayjs(record.from_date).format('DD-MM-YYYY')} to {dayjs(record.to_date).format('DD-MM-YYYY')}</Typography.Text>
                        },
                        {
                            dataIndex: 'delete',
                            key: 'delete',
