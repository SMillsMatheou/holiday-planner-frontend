...
import { UserOutlined, CalendarOutlined, ScheduleOutlined, LogoutOutlined } from '@ant-design/icons';
...
export default function ProtectedLayout() {
    ...
    const items = [
        ...
        getItem(<Button type="link" onClick={() => {
            logout();
            setUser(null);
            navigate('/');
        }}>Logout</Button>, 8, <LogoutOutlined />)
    ]
    ...
    return ( 
        <Layout style={{minHeight: '100vh'}} >
            ...
            <Layout>
                ...
                <Footer style={{textAlign: 'center'}}>Samtest footer ©2023 Created by Sam</Footer>
            </Layout>
        </Layout>
    )
}